...
const SummitPlan = ({ open, onPress }: PlanProps) => {
            ...
            <View>
              <View
                ...
                <View
                  ...
                  <Text className="mb-2 font-roboto text-[20px] font-bold text-[#10A9B3]">
                    $119
                  </Text>
                  <Text className="mb-2 font-roboto text-[14px] font-normal text-[#C2C2C2]">
                    User | Month
